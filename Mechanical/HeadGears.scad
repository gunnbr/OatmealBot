...
od = outer_radius(mm_per_tooth,n1) * 2;
echo("Pitch radius = ", d1, "Outside diameter = ", od);
...
union() {
  difference() {
  	  gear(mm_per_tooth,n1,thickness,hole);
	  translate([d1-7,0,-thickness/2]) cylinder(r=2, h=thickness*2);
  }
  difference() {
    translate([0,0,thickness/2]) cylinder(r=4.5,h=8);
    translate([0,0,thickness/2]) cylinder(r=4.8/2, h=8);
    cylinder(r=hole/2, h=8);
    translate([0,4.5,thickness/2 + 5]) rotate(a=[90,0,0]) cylinder(r=1.1,h=9);
    translate([-1.1,-4.5,thickness/2 + 5]) cube(size=[2.2, 9, 5]);
  }
}
...
// 5 teeth            :  5.57042               15.3972
// 7 teeth, 7 mm/tooth:  7.79859 pitch radius, 19.8535 outer diameter
// 9 teeth            : 10.0268                24.3009
// 14 teeth           : 15.5973                35.4507
// 18 teeth           : 20.0535                44.3634

// 7 teeth, 5 mm/tooth:  5.57042 PR, 14.1239 OD
